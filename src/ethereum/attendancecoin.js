...
export const AttendanceCoin_Faucet = new web3.eth.Contract(JSON.parse(attendancecoin_faucet.interface), "0x78db8306dfb3181f91a2f49d324cd5e0a7e1df24"); // - AC faucet
