...
export const AttendanceCoin_Faucet = new web3.eth.Contract(JSON.parse(attendancecoin_faucet.interface), "0x9fda990ee7169000a3249010207988565c79c7b8"); // - AC faucet
