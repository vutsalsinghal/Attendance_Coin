...
function networkCheck(){
  web3.eth.net.getNetworkType((err, netId) => {
    switch (netId) {
      case "main":
        alert("This is Mainnet. Please switch to Rinkeby Test Network!");
        break
      case "ropsten":
      ...
      case "rinkeby":
        ...
        break
      case "kovan":
        alert("This is Kovan test network. Please switch to Rinkeby Test Network!");
        break
      default:
        alert('This is an unknown network. Please connect to Rinkeby Test Network!');
    }
    })
  }
